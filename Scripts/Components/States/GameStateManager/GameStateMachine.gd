...
func transition_state():
	if Input.is_action_just_pressed("pause"):
		current_state.transitioned.emit(self, current_state, "pause")
	if Input.is_action_just_pressed("interact"):
		current_state.transitioned.emit(self, current_state, "interacting")
	if Input.is_action_just_pressed("journal"):
		current_state.transitioned.emit(self, current_state, "journal")
	...
	if  check_is_in_menu() and Input.is_action_just_pressed("return"):
		current_state.transitioned.emit(self, current_state, "moving")
